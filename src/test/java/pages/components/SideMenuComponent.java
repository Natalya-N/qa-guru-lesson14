...
public class SideMenuComponent {
    ...
    private final List<String> elements = List.of("Собрали для вас", "От Самоката", "Готовая еда", "Овощи и фрукты",
            ...
            "ЗОЖ и веганство", "Для детей", "Красота и здоровье", "Одежда, обувь и аксессуары", "Для животных",
            "Всё для дома", "Канцелярия, хобби и спорт", "Техника и электроника", "Для автомобиля");
